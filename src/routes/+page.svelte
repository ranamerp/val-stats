...
<main>
    <!-- Header. Have to change but for now this should suffice -->
    <header>
        <!-- lg+ -->
    ...
    <!-- Top Bar. Used to select matches, search players, etc -->
    <div class="">
    </div>
    
    <!-- This is where the side bars, and the main stats component will go. -->
    <div class="grid grid-cols-3 grid-auto">
    </div>

    <!-- This is where users can export, maybe would do something else too idk -->
    <div class="">
    </div>
